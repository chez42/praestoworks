...
{strip}
	<style>
		body {
			background: url(layouts/v7/resources/Images/USS_Ronald_Reagan.jpg);
	...
	<div class="container-fluid loginPageContainer">
		<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/Praesto_Main_Logo_1953x306.jpg">
				<div>
                ...
                <div class="col-lg-1">
                  ...
                  <div class="col-lg-5" style="background-color: rgba(255, 255, 255, 0.6);color:black;">
                    <h1>USS Ronald Reagan (CVN-76)</h1>
                   <h3>Rendering honors to the USS Arizona (BB-39).</h3>
                  </div>
				    ...
				    $.ajax({
				        ...
				        success: function (data) {
				            if (data.status === 'success') {
				                ...
				                $(".failureMessage").show().text('Login failed');
				            }
				        }
				    });
				});
